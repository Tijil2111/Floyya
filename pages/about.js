      ...
      <div className="flex flex-wrap flex-row gap-14 justify-center  pt-20  font-poppinsLight pl-10 text-[20px]">
        <div className="flex flex-col h-[600px] w-[300px] bg-gradient-to-r from-main-light via-main-mid-1 to-main-dark rounded-md">
          ...
          <div className="self-center text-center pt-10 pl-5 pr-5 font-poppinsLight text-white text-[15px]">
            ...
            approached me with the idea of floyya I agreed at once. Because at
            the end of the day I am also a girl and to be able to do something
            to make the lives of the girls easier, it just felt like my dream
            was slowly starting to come true.
          </div>
        </div>
        <div className="flex flex-col h-[600px] w-[300px] bg-gradient-to-r from-main-light via-main-mid-1 to-main-dark rounded-md">
          <img
          ...
          <div className="self-center text-center pt-10 pl-5 pr-5 font-poppinsLight text-white text-[15px]">
            ...
            immensely moved by it. I know that most people would shy away or
            feel embarrassed to talk about this subject but I feel like it is
            our moral duty to break away from that stigma and I am so grateful
            that I was given a chance to be a part of something so huge.
          </div>
        </div>
        <div className="flex flex-col h-[600px] w-[300px] bg-gradient-to-r from-main-light via-main-mid-1 to-main-dark rounded-md">
          <img
          ...
          <div className="self-center text-center pt-10 pb-5 pl-5 pr-5 font-poppinsLight text-white text-[15px]">
            ...
            their aid and development I got inspired to take this product owing
            to the social stigma and lack of awareness regarding such a crucial
            sanitary product among people , especially men.
          </div>
        </div>
        <div className="flex flex-col h-[600px] w-[300px] bg-gradient-to-r from-main-light via-main-mid-1 to-main-dark rounded-md">
          <img
          ...
          <div className="self-center text-center pt-10 pl-5 pr-5 font-poppinsLight text-white text-[15px]">
            ...
            lockdown when while talking to our househelp and her daughter. They
            depicted their problems in such a vivid and impactful way,
