      ...
      <div className="flex flex-wrap justify-center pt-20">
        ...
        <div className="flex flex-col w-[500px]">
          <div className="font-poppinsLight text-xl lg:p-20 lg:w-[800px]">
            ...
            provides up to 0% leakage all night long. It contains a dual-action
            gel that both neutralises odour and locks in moisture. Its Dri-Weave
            Cover absorbs period blood in seconds, allowing you to sleep
